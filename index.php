<!DOCTYPE html>                   <!--Начало) Дарья, спасибо-->
<html lang="en-us">
  <head>
    <meta charset="utf-8">
  ...
  <div class="container">
  <div class ="box_table">
    <h2>Таблица истинности</h2> <!--Таблица истинности PHP-->
    ...
    <div class ="box_table">                       <!--Гибкое сравнение в PHP-->    
          <h2>Гибкое сравнение в PHP</h2>
            ...
            <div class="box_table">                     <!--Жёсткое сравнение PHP-->
